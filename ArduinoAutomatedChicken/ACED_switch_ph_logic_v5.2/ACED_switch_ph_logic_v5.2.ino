...
void loop()  // main loop that runs the operations of the circiut
{
  ...
  int analogValuePh2;
  int digitalValueSw1;
  int lightAverage1 = 0, lightAverage2 = 0;
...
//  analogValuePh1 = analogRead(photocellPin0);
 ...
 // analogValuePh2 = analogRead(photocellPin1);
  ...
  {
    delay(300);
    lightAverage1 = lightAverage1 + analogRead(photocellPin0);
    delay(400);
    lightAverage2 = lightAverage2 + analogRead(photocellPin1);
  }
  
  analogValuePh1 = (lightAverage1/9);
  analogValuePh2 = (lightAverage2/9);
